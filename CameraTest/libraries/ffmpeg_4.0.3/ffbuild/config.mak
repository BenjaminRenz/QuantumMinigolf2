...
CC_IDENT=gcc 7.3.0 (Rev2, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_WIN32_WINNT=0x0600 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
...
HOSTCPPFLAGS= -D_ISOC99_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_WIN32_WINNT=0x0600 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=gcc
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -lvfw32
EXTRALIBS-avfilter=-lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -lsecur32 -lws2_32
EXTRALIBS-avcodec=-liconv -lm -lz -lole32 -luser32
